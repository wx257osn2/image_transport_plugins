/*
Based from https://github.com/wx257osn2/qoixx ef734e0d21fc34d148e4a24b1b4e5d72a0f26e5d
...
class qoi{
 ...
 public:
  ...
  struct desc{
    ...
    constexpr bool operator==(const desc& rhs)const noexcept{
      return width == rhs.width && height == rhs.height && channels == rhs.channels && colorspace == rhs.colorspace;
    }
  };
  struct rgba_t{
    std::uint8_t r, g, b, a;
